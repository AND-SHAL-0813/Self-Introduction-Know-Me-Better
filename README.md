...
**Shalini Anand** *Second-Year Engineering Student | Programmer | Problem Solver*

---

![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&pause=1000&color=4A90E2&center=true&vCenter=true&width=435&lines=Welcome+to+my+profile!;C%2B%2B+%2B+Python+Developer;Data+Science+Enthusiast)
...
### 🧠 About Me
I am a dedicated engineering student focused on building efficient solutions and mastering new technologies.

* **💻 Tech Stack:** `C++`, `Python`, `Data Structures`
* **📊 Analytics:** `Pandas`, `NumPy`
* **🎨 Creative:** Presentation Design (`Canva`)
* **🎯 Goal:** Software Development & Networking

---

### 📌 Why This Repository?
This repository serves as a professional touchpoint for academic coordinators and recruiters to understand my communication skills and technical foundation.
